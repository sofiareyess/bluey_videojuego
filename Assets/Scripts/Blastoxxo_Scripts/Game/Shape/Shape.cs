...
IPointerDownHandler
{
    ...
    public void CreateShape(ShapeData shapeData)
    {
        ...
        //loop to set position to form shape
    ...
    private float GetYPositionForShapeSquare(ShapeData shapeData, int row, Vector2 moveDistance)
    {
        ...
        if (shapeData.rows > 1)
        {
            if (shapeData.rows % 2 != 0)
            {
                ...
                if (row < middleSquareIndex)// move on negative
                {
            ...
            else
            {
                ...
                if (row < middleSquareIndex1 && row < middleSquareIndex2) //move in negative
                {
                    shiftOnY = moveDistance.y *1;
                    shiftOnY *= multiplier;
                }
                else if (row > middleSquareIndex1 && row > middleSquareIndex2)// move on positive
                {
                    shiftOnY = moveDistance.y * -1;
                    shiftOnY *= multiplier;
                }
    ...
    private float GetXPositionForShapeSquare(ShapeData shapeData, int column, Vector2 moveDistance)
    {
        ...
        if (shapeData.columns > 1)
        {
            ...
            else
            {
                ...
                else if (column > middleSquareIndex1 && column > middleSquareIndex2) //move on positive
                {
                    shiftOnX = moveDistance.x * 1;
                    shiftOnX *= multiplier;
                }
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        dragOffset = _transform.anchoredPosition - localPointerPosition;
    }
     ...
     public void OnDrag(PointerEventData eventData)
     {
        ...
        {
            _transform.anchoredPosition = localPointerPosition + dragOffset;
        }
     }
